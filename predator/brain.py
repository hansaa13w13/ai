...
def brain_load() -> dict:
    ...
    data.setdefault("learned_weights", {"formation": {}, "indicator": {}})
    data.setdefault("sector_perf", {})
    data.setdefault("sector_mode_matrix", {})
    data.setdefault("volatility_learning", {})
    data.setdefault("confluence_patterns", {})
    data.setdefault("time_patterns", {})
    data.setdefault("prediction_accuracy", {"toplam": 0, "dogru": 0, "oran": 0.0})
    data.setdefault("stats", {"recent_wins": 0, "recent_total": 0,
                              "avg_win_pct": 5.0, "avg_loss_pct": 3.0})
